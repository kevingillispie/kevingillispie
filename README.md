...
### [OverPhish](https://overphish.app){:target="_blank"} – Real-time Phishing & Malware Blocker (2025)  
...
- **[Schema Scalpel](https://schemascalpel.com){:target="_blank"}** – Per-page JSON-LD editor for WordPress (50+ active installs)  
- 7+ years shipping production PHP, modern JavaScript/Node, Next.js 
- Google Cybersecurity Certificate • CompTIA Network+
- Full scource code: [github.com/kevingillispie/Schema-Scalpel](https://github.com/kevingillispie/Schema-Scalpel)  
...
[kevingillispie.com](https://kevingillispie.com){:target="_blank"} • [linkedin.com/in/kevinlgillispie](https://linkedin.com/in/kevinlgillispie){:target="_blank"} • hello[at]kevingillispie.com
